...
// End Cross Module References
	DEFINE_FUNCTION(UHealthComponent::execTakeDamage)
	{
		...
		P_GET_OBJECT(AController,Z_Param_InstigayedBy);
		P_GET_OBJECT(AActor,Z_Param_DamageCauser);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->TakeDamage(Z_Param_DamagedActor,Z_Param_Damage,Z_Param_DamageType,Z_Param_InstigayedBy,Z_Param_DamageCauser);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UHealthComponent_TakeDamage_Statics
	{
		...
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_InstigayedBy;
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHealthComponent_TakeDamage_Statics::NewProp_InstigayedBy = { "InstigayedBy", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HealthComponent_eventTakeDamage_Parms, InstigayedBy), Z_Construct_UClass_AController_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UHealthComponent_TakeDamage_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UHealthComponent_TakeDamage_Statics::NewProp_InstigayedBy,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHealthComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHealthComponent_TakeDamage, "TakeDamage" }, // 3705505092
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UHealthComponent, 3580903230);
